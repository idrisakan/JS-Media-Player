...
const songsList = [
    ...
    {
        name: "Rinde",
        link: "assets/Rinde.mp3",
        artist: "Mem Ararat",
        image: "assets/mem ararat.jpg"
    },
    {
        name: "Aramam",
    ...
    {
        name: "Yillar Afetmez",
        link: "assets/yillar affetmez.mp3",
        artist: "Melek Mosso",
...
setInterval(() => {
    ...
    //progress ilerleteceğiz
    currentProgress.style.width = (audio.currentTime / audio.duration.toFixed(3)) * 100 + "%"
}, 1000);

//şarkı süresi değişim kismi tiklanildiğina
...
shuffleButton.addEventListener('click', () =>{
 ...
 //şarki bittiğinde,
 audio.onended = () =>{
    nextSong() //sonraki şarkiyi çağir
 }
